...
| 트레이 아이콘 | Simple 모드 | Detailed 모드 |
|:---:|:---:|:---:|
| ![트레이 아이콘](capture/capture1.png) | ![Simple 모드](capture/capture2.png) | ![Detailed 모드](capture/capture3.png) |

> 위젯 헤더에 Clawd 스크래치 애니메이션이 표시됩니다. 트레이 메뉴에서 끌 수 있습니다.
...
| Show Animation | Clawd 애니메이션 표시/숨김 (끄면 헤더 최소화) |
...
| `show_animation` | `true` | `false` 시 Clawd 애니메이션 숨김 (헤더 최소화) |
